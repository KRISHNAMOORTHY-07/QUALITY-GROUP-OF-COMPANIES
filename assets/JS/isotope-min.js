...
function(t, e) {
    ...
    function i() {
        if (!u) {
            ...
            s.appendChild(i);
            var r = e(i);
            n.isBoxSizeOuter = o = 200 == t(r.width),
            s.removeChild(i)
        }
    }
    function n(n) {
        ...
        n && "object" == typeof n && n.nodeType) {
            ...
            for (var h = u.isBorderBox = "border-box" == s.boxSizing, d = 0; a > d; d++) {
                var l = r[d]
                  , f = s[l]
                  , c = parseFloat(f);
                u[l] = isNaN(c) ? 0 : c
    ...
    , r = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], a = r.length, u = !1;
    return n
}),
function(t, e) {
    "use strict";
    ...
    f.updateStagger = function() {
        ...
        return null == t ? void (this.stagger = 0) : (this.stagger = function(t) {
            ...
            var e = t.match(/(^\d*\.?\d*)(\w*)/)
              , i = e && e[1]
              , n = e && e[2];
            return i.length ? (i = parseFloat(i)) * (c[n] || 1) : 0
        }(t),
        this.stagger)
    }
    ,
...
function(t, e) {
    ...
    i.prototype._getItemLayoutPosition = function(t) {
        ...
        for (var n = this._getColGroup(i), o = Math.min.apply(Math, n), s = n.indexOf(o), r = {
            ...
            y: o
        }, a = o + t.size.outerHeight, u = this.cols + 1 - n.length, h = 0; u > h; h++)
            this.colYs[s + h] = a;
        return r
    }
    ,
    ...
    i.prototype._manageStamp = function(t) {
        ...
        for (var u = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, h = r; a >= h; h++)
